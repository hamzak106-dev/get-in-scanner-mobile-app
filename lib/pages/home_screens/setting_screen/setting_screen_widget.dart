              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  gradient: RadialGradient(
                    colors: [
                      Color(0xFFFF281B).withOpacity(0.8),
                      Color(0xFFFF4C00).withOpacity(0.8), // 80% opacity
// 80% opacity
                    ],
                  ),
                ),
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                wrapWithModel(
                                  model: _model.settingTileModel14,
                                  updateCallback: () => safeSetState(() {}),
                                  child: SettingTileWidget2(
                                    iconPath: "assets/svg/video-play.svg",
                                    title: 'Media Cache',
                                    endLable: "100%",
                                ...
                                wrapWithModel(
                                  ...
                                  updateCallback: () => safeSetState(() {}),
                                  child: SettingTileWidget2(
                                    iconPath: "assets/svg/document.svg",
                                    title: 'Tutorials',
                                    endLable: "Read More",
                                    showTrailingIcon: true,
                                    onTap: () async {
