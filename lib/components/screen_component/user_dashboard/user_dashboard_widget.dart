  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      await actions.watchAuthorisedAttendees(
        ...
        functions.parseEventRow(FFAppState().selectedEvent.toList()).map((e) => e.eventId).toList().toList(),
        true,
      ...
      var utcDate = DateTime.fromMillisecondsSinceEpoch(getCurrentTimestamp.secondsSinceEpoch * 1000);
      _model.isLoading = false;
      _model.hasLookUp = _model.lookUpAvailable!;
      _model.isUpcoming =
          functions.parseEventRow(FFAppState().selectedEvent.toList()).firstOrNull!.endDate.secondsSinceEpoch >=
      ...
      _model.isFirstEvent = _model.events.firstOrNull?.uid ==
          functions.parseEventRow(FFAppState().selectedEvent.toList()).firstOrNull?.uid;
            ...
            children: [
              FlutterFlowIconButton(
                ...
                onPressed: () async {
                  ...
                  if (!_model.isFirstEvent) {
                    ...
                    _model.updatePage(() {});
                    _model.previousEvents = await actions.choosePreviousNextEvent(
                      false,
                      _model.isUpcoming,
                    );
                    FFAppState().selectedEvent = functions
                        .parseRowToJson(_model.previousEvents?.toList(), _model.previousEvents?.firstOrNull)
                        .toList()
                        .cast<dynamic>();
                    FFAppState().update(() {});
                    var utcDate = DateTime.fromMillisecondsSinceEpoch(getCurrentTimestamp.secondsSinceEpoch * 1000);
                    _model.allEventsFromPrevious = await actions.getEventsOfUser();
                    ...
                    safeSetState(() {});
                      await actions.watchAuthorisedAttendees(
                      (result) async {
                        _model.getAttendeeListResponseLeft = await actions.getAttendeeList(
                          result?.toList(),
                        );
                        _model.attedees = _model.getAttendeeListResponseLeft!.toList().cast<AttendeeRow>();
                        _model.isLoading = false;
                        safeSetState(() {});
                      },
                      functions.parseEventRow(FFAppState().selectedEvent.toList()).map((e) => e.eventId).toList(),
                      true,
                      AccessPermission.lookup,
                    );
                  }
              ...
              Expanded(
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('USER_DASHBOARD_COMP_Text_qet8uyme_ON_TAP');
                    ...
                    await actions.watchAuthorisedAttendees(
                      (result) async {
                        _model.getAttendeeListResponseCenter = await actions.getAttendeeList(
                          result?.toList(),
                        );
                        _model.attedees = _model.getAttendeeListResponseCenter!.toList().cast<AttendeeRow>();
                        _model.isLoading = false;
                        safeSetState(() {});
                      },
                      functions.parseEventRow(FFAppState().selectedEvent.toList()).map((e) => e.eventId).toList(),
                  ...
                  child: Text(
                    FFAppState().selectedEvent.length == 1
                        ? valueOrDefault<String>(
                            functions.parseEventRow(FFAppState().selectedEvent.toList()).firstOrNull?.title,
                            '-',
                          )
                        : 'Select an Event',
              ...
              FlutterFlowIconButton(
                ...
                onPressed: () async {
                  ...
                  if (!_model.isLastEvent) {
                    ...
                    FFAppState().selectedEvent = functions
                        .parseRowToJson(_model.nextEvents?.toList(), _model.nextEvents?.firstOrNull)
                        .toList()
                        .cast<dynamic>();
                    FFAppState().update(() {});
                    ...
                    await actions.watchAuthorisedAttendees(
                      (result) async {
                        _model.getAttendeeListResponseRight = await actions.getAttendeeList(
                          result?.toList(),
                        );
                        _model.attedees = _model.getAttendeeListResponseRight!.toList().cast<AttendeeRow>();
                        _model.isLoading = false;
                        safeSetState(() {});
                      },
                      functions.parseEventRow(FFAppState().selectedEvent.toList()).map((e) => e.eventId).toList(),
                        ...
                        children: [
                          ...
                          Builder(
                            builder: (context) => FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                logFirebaseEvent('USER_DASHBOARD_icOutlineCamera_ICN_ON_TA');
                                await showModalBottomSheet(
                                  isScrollControlled: true,
                                  ...
                                  builder: (context) {
                                    return Padding(
                                      ...
                                      child: SizedBox(
                                        height: MediaQuery.sizeOf(context).height * 0.9,
                                        child: const LookupScannerBottomSheetWidget(),
                                      ),
                                    );
                                  },
                                ).then((value) => safeSetState(() => _model.scannedValue = value));

                                if (_model.scannedValue != null && _model.scannedValue != '') {
                                  ...
                                  if (_model.permissionResult == ScanResult.VALID) {
                                    _model.redirectAttendeeResponse = await actions.findAttendee(
                                      _model.scannedValue,
                                      functions
                                          .parseEventRow(FFAppState().selectedEvent.toList())
                                          .map((e) => e.eventId)
                                        ...
                                        builder: (dialogContext) {
                                          return Dialog(
                                            ...
                                            child: InfoDialogWidget(
                                              ...
                                              firstBtnText: 'OK',
                                              firstBtnColor: FlutterFlowTheme.of(context).primaryText,
                                              firstTap: () async {
                          ...
                          Container(
                            ...
                            child: custom_widgets.FilterPopUp(
                              ...
                              onChange: (value) async {
                                logFirebaseEvent('USER_DASHBOARD_Container_0i8ktp3x_CALLBA');
                            ...
                            Flexible(
                              child: Align(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  ...
                                  borderWidth: 0.0,
                                  borderRadius: 5.0,
                                  margin: EdgeInsetsDirectional.fromSTEB(16.0, 12.0, 12.0, 12.0),
                                  hidesUnderline: true,
                                  isOverButton: false,
                                  isSearchable: false,
                                  isMultiSelect: false,
                          ...
                          Expanded(
                            child: wrapWithModel(
                              ...
                              child: SearchTextFieldWidget(
                                onChange: () async {
                                  logFirebaseEvent('USER_DASHBOARD_Container_n3vxt2oc_CALLBA');
                                ...
                                children: [
                                  Expanded(
                                    child: Builder(
                                      builder: (context) {
                                        final attendee = () {
                                          if (_model.status == AttendeeFilterBy.CHECK_IN) {
                                            return (_model.ascending
                                                ? functions
                                                    .filterAttendeeList(_model.attedees.toList(),
                                                ...
                                                : functions
                                                    ...
                                                    .where((e) => e.status == ScanResult.CHECK_IN.name)
                                                    .toList());
                                          } else if (_model.status == AttendeeFilterBy.CHECK_OUT) {
                                            return (_model.ascending
                                                ? functions
                                                    .filterAttendeeList(_model.attedees.toList(),
                                                        _model.searchTextFieldModel.textController.text)
                                                    .sortedList(keyOf: (e) => e.name!, desc: false)
                                                    .where((e) => e.status == ScanResult.CHECK_OUT.name)
                                                    .toList()
                                                : functions
                                                    .filterAttendeeList(_model.attedees.toList(),
                                                        _model.searchTextFieldModel.textController.text)
                                                    ...
                                                    .where((e) => e.status == ScanResult.CHECK_OUT.name)
                                                    .toList());
                                          } else if (_model.status == AttendeeFilterBy.ABSENT) {
                                            return (_model.ascending
                                                ? functions
                                                    .filterAttendeeList(_model.attedees.toList(),
                                                        _model.searchTextFieldModel.textController.text)
                                                    .sortedList(keyOf: (e) => e.name!, desc: false)
                                                    .where((e) => e.status == null || e.status == '')
                                                    .toList()
                                                : functions
                                                    .filterAttendeeList(_model.attedees.toList(),
                                                        _model.searchTextFieldModel.textController.text)
                                        ...
                                        return ListView.builder(
                                          ...
                                          itemBuilder: (context, attendeeIndex) {
                                            ...
                                            return AttendeeCardWidget(
                                              key: Key('Keysg4_${attendeeIndex}_of_${attendee.length}'),
                                              attendee: attendeeItem,
                                              onTap: () async {
                                                logFirebaseEvent('USER_DASHBOARD_Container_sg4wzfmh_CALLBA');
                                          ...
                                          children: [
                                            Expanded(
                                              child: InkWell(
                                                ...
                                                highlightColor: Colors.transparent,
                                                onTap: () async {
                                                  logFirebaseEvent('USER_DASHBOARD_Container_8qf7vjoy_ON_TAP');
                                                  _model.status = AttendeeFilterBy.ALL;
                                                  safeSetState(() {});
                                                },
                                                child: Container(
                                                  decoration: BoxDecoration(
                                                    color: _model.status == AttendeeFilterBy.ALL
                                            ...
                                            Expanded(
                                              child: InkWell(
                                                ...
                                                highlightColor: Colors.transparent,
                                                onTap: () async {
                                                  logFirebaseEvent('USER_DASHBOARD_Container_zvzm5deu_ON_TAP');
                                                  _model.status = AttendeeFilterBy.ABSENT;
                                                  safeSetState(() {});
                                                },
                                                child: Container(
                                                  decoration: BoxDecoration(
                                                    color: _model.status == AttendeeFilterBy.ABSENT
                                                        ? FlutterFlowTheme.of(context).secondary
                                                        : Colors.transparent,
                                                    borderRadius: BorderRadius.circular(50.0),
                                                    shape: BoxShape.rectangle,
                                            ...
                                            Expanded(
                                              child: InkWell(
                                                ...
                                                highlightColor: Colors.transparent,
                                                onTap: () async {
                                                  logFirebaseEvent('USER_DASHBOARD_Container_hpz8zwcs_ON_TAP');
                                                  _model.status = AttendeeFilterBy.CHECK_OUT;
                                                  safeSetState(() {});
                                                },
                                                child: Container(
                                                  decoration: BoxDecoration(
                                                    color: _model.status == AttendeeFilterBy.CHECK_OUT
                                                        ? FlutterFlowTheme.of(context).secondary
                                                        : Colors.transparent,
                                                    borderRadius: BorderRadius.circular(50.0),
                                                    shape: BoxShape.rectangle,
                                            ...
                                            Expanded(
                                              child: InkWell(
                                                ...
                                                highlightColor: Colors.transparent,
                                                onTap: () async {
                                                  logFirebaseEvent('USER_DASHBOARD_Container_s2y8ro2u_ON_TAP');
                                                  _model.status = AttendeeFilterBy.CHECK_IN;
                                                  safeSetState(() {});
                                                },
                                                child: Container(
                                                  decoration: BoxDecoration(
                                                    color: _model.status == AttendeeFilterBy.CHECK_IN
                                                        ? FlutterFlowTheme.of(context).secondary
                                                        : Colors.transparent,
                                                    boxShadow: [
                                                      BoxShadow(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent('USER_DASHBOARD_SELECT_AN_EVENT_BTN_ON_TA');
                                  await _model.openEventsBottomSheetActionBlock(context);
                                },
