...
class SelectedInfoCard extends StatelessWidget {
  ...
  const SelectedInfoCard({super.key, required this.section, required this.row, required this.seat, required this.price, required this.onSelect, required this.onDismiss});
